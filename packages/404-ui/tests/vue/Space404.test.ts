...
describe("Space404 (vue)", () => {
  ...
  it("emits buttonClick when button clicked", async () => {
    const wrapper = mount(Space404, { props: CUSTOM_PROPS });
    await wrapper.find("button.space-404-button").trigger("click");
